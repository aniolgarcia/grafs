...
metro(metro_barcelona, "4_Llucmajor", "9S_Aeroport T1")
\end{minted}
...
Un altre avantatge de \LaTeX\ és que també permet la utilització de diversos paquets que afegeixen funcionalitats addicionals. Durant la redaccó d'aquesta memòria se n'han utilitzat un total de 35, i els següents són els més importants:
